package com.ponpes.dahlanikhsan.backend.domain.example;
...
public class DummyData {
	...
	private static final Map<Long, MatPel> MATPELS = new HashMap<>();
...
//			MATPELS.put(i, new MatPel( (int) i, "", "", "", "", created, lastModified, modifiedBy));
	...
	public static Collection<MatPel> getMatPels() {
		return MATPELS.values();
	}
